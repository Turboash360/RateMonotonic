...
int main(int argc, char *argv[])
{
  ...
  float B = 3*(pow(2,0.33333333)-1);
  float U = (wcet1/period1) + (wcet2/period2) + (wcet3/period3);
  ...
  float largest;
  float LCM = period1*period2*period3;


  while(LCM % period1 == 0 && LCM % period2 == 0 && LCM % period3 == 0)
    {
  if(period1 > period2 && period1 > period3)
    {
      largest = period1;
    }
  else if(period2 > period1 && period2 > period3)
    {
      largest = period2;
    }
  else if(period3 > period1 && period3 > period2)
    {
      largest = period3;
   }
